...
# The docs/figures/outputs for the schlafli paper can live in three places:
#   - main VFD research repo: docs/schlafli_24_600/
#   - combined two-paper public bundle: docs/01-schlafli-decomposition/
#   - legacy single-paper bundle: docs/
_DOCS_CANDIDATES = [
    REPO / "docs" / "schlafli_24_600",
    REPO / "docs" / "01-schlafli-decomposition",
    REPO / "docs",
]
